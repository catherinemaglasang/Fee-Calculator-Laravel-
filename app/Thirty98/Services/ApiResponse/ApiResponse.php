<?php namespace Thirty98\Thirty98\Services\ApiResponse;
...
class ApiResponse
{
     ...
     * @return array
     */
    public static function prepareResponse($httpCode, $responseCode, $responseMsg, $data, $success = true)
    {
        return [
        	'success' => $success,
            'http_code' => $httpCode,
     ...
     * @return \Illuminate\Contracts\Routing\ResponseFactory|\Symfony\Component\HttpFoundation\Response
     */
    public static function error($responseCode = '', $responseMsg = '', $data = [], $httpCode = 200, $headers = [], $success = false)
    {
        $responseCode = !$responseCode ? ApiResponse::CODE_BAD_REQUEST : $responseCode;

        $response = self::prepareResponse($httpCode, $responseCode, $responseMsg, $data, $success);
