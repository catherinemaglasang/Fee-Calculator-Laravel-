...
class TruckCombinationTruckRepository implements CalculatorRepositoryInterface
{
    const STATE_CODE = 'TX';
    const CATEGORY = 'truck';
    const TYPE = 'combination-truck';
    ...
    {
        return $this->getRegFee($this->request->get('vin_pattern')) * 0.10;
    }
