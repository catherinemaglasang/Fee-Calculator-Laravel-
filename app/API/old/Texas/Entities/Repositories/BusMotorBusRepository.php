...
class BusMotorBusRepository implements CalculatorRepositoryInterface
{
    const STATE_CODE = 'TX';
    const CATEGORY = 'bus';
    const TYPE = 'motor-bus';
    ...
    {
        // Get number of seats x 150 lbs.
        $gvwr = $this->request->get('seat_no', 0) * 150;
