...
class Truck12PickupTruckRepository implements CalculatorRepositoryInterface
{
    const STATE_CODE = 'TX';
    const CATEGORY = 'truck';
    const TYPE = '1-2-pickup-truck';
    ...
    {
        return $this->getRegFee($this->request->get('vin_pattern'));
    }
