...
class Truck1TonPickupTruckRepository implements CalculatorRepositoryInterface
{
    const STATE_CODE = 'TX';
    const CATEGORY = 'truck';
    const TYPE = '1-ton-pickup-truck';
    ...
    {
        return $this->getRegFee($this->request->get('vin_pattern')) * 0.50;
    }
    ...
    public function getDieselFee()
    {
        ...
        if ($fuelType == 'DIESEL' AND $gvw > 18000) {
            return $this->getRegFee($this->request->get('vin_pattern')) * 0.11;
        }
