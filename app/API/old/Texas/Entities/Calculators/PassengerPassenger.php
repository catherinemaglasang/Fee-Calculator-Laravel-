...
use Thirty98\API\Texas\Entities\Repositories\PassengerPassengerFeeRepository;

class PassengerPassenger extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    {
        $this->calculateFees(new PassengerPassengerFeeRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param PassengerPassengerFeeRepository $repository
     */
    private function calculateFees(PassengerPassengerFeeRepository $repository)
    {
        $this->fees = [
