...
class TrailerTokenTrailer extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    {
        $this->calculateFees(new TrailerTokenTrailerRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param TrailerTokenTrailerRepository $repository
     */
    private function calculateFees(TrailerTokenTrailerRepository $repository)
    {
        $this->fees = [
            'EMISSION_FEE' => 0,
