...
use Thirty98\API\Texas\Entities\Repositories\BusCityBusRepository;
use Thirty98\API\Texas\Entities\Repositories\BusPrivateBusRepository;
use Thirty98\API\Texas\Entities\Repositories\MotorcycleMopedRepository;

class MotorcycleMoped extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    public function calculate()
    {
        try {
            ...
            $this->calculateFees(new MotorcycleMopedRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param MotorcycleMopedRepository $repository
     */
    private function calculateFees(MotorcycleMopedRepository $repository)
    {
        $this->fees = [
