...
class BusCityBus extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    {
        $this->calculateFees(new BusCityBusRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param BusCityBusRepository $repository
     */
    private function calculateFees(BusCityBusRepository $repository)
    {
        $this->fees = [
