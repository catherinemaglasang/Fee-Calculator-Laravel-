...
class Truck1TonPickupTruck extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    {
        $this->calculateFees(new Truck1TonPickupTruckRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param Truck1TonPickupTruckRepository $repository
     */
    private function calculateFees(Truck1TonPickupTruckRepository $repository)
    {
        $this->fees = [
