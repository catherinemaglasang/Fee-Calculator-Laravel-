...
class BusMotorBus extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    {
        $this->calculateFees(new BusMotorBusRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param BusMotorBusRepository $repository
     */
    private function calculateFees(BusMotorBusRepository $repository)
    {
        $this->fees = [
