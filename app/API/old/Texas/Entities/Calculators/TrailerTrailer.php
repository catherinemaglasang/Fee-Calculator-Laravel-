...
class TrailerTrailer extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    {
        $this->calculateFees(new TrailerTrailerRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param TrailerTrailerRepository $repository
     */
    private function calculateFees(TrailerTrailerRepository $repository)
    {
        $this->fees = [
