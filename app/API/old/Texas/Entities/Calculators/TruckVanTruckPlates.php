...
use Thirty98\API\Texas\Entities\Repositories\TruckVanTruckPlatesRepository;
use Thirty98\API\Texas\Entities\Repositories\VanTruckPlatesTruckFeeRepository;

class TruckVanTruckPlates extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    {
        $this->calculateFees(new TruckVanTruckPlatesRepository($this->calculatorInput->getRequest()));
     ...
     *  Calculate all fees.
     *
     * @param TruckVanTruckPlatesRepository $repository
     */
    private function calculateFees(TruckVanTruckPlatesRepository $repository)
    {
        $this->fees = [
