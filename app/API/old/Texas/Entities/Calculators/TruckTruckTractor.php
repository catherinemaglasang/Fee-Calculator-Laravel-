...
class TruckTruckTractor extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    {
        $this->calculateFees(new TruckTruckTractorRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param TruckTruckTractorRepository $repository
     */
    private function calculateFees(TruckTruckTractorRepository $repository)
    {
        $this->fees = [
