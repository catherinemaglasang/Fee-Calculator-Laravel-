...
class Truck12PickupTruck extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    {
        $this->calculateFees(new Truck12PickupTruckRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param Truck12PickupTruckRepository $repository
     */
    private function calculateFees(Truck12PickupTruckRepository $repository)
    {
        $this->fees = [
