...
use Thirty98\API\Texas\Entities\Repositories\MotorcycleMiniBikeRepository;

class MotorcycleMiniBike extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    public function calculate()
    {
        try {
            ...
            $this->calculateFees(new MotorcycleMiniBikeRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param MotorcycleMiniBikeRepository $repository
     */
    private function calculateFees(MotorcycleMiniBikeRepository $repository)
    {
        $this->fees = [
