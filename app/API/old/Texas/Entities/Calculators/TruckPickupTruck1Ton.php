...
use Thirty98\API\Texas\Entities\Repositories\Truck1TonPickupTruckRepository;
use Thirty98\API\Texas\Entities\Repositories\Truck34PickupTruckRepository;
use Thirty98\API\Texas\Entities\Repositories\TruckPickupTruck1TonRepository;

class TruckPickupTruck1Ton extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    {
        $this->calculateFees(new TruckPickupTruck1TonRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param TruckPickupTruck1TonRepository $repository
     */
    private function calculateFees(TruckPickupTruck1TonRepository $repository)
    {
        $this->fees = [
