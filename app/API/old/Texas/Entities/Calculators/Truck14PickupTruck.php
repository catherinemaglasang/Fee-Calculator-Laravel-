...
use Thirty98\API\Texas\Entities\Repositories\Truck14PickupTruckRepository;

class Truck14PickupTruck extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    {
        $this->calculateFees(new Truck14PickupTruckRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param Truck14PickupTruckRepository $repository
     */
    private function calculateFees(Truck14PickupTruckRepository $repository)
    {
        $this->fees = [
