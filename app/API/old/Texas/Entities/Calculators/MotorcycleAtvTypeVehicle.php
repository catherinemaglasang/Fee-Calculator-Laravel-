...
class MotorcycleAtvTypeVehicle extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    public function calculate()
    {
        try {
            ...
            $this->calculateFees(new MotorcycleAtvTypeVehicleRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param MotorcycleAtvTypeVehicleRepository $repository
     */
    private function calculateFees(MotorcycleAtvTypeVehicleRepository $repository)
    {
        $this->fees = [
