...
use Thirty98\API\Texas\Entities\Repositories\VintageCollectorVehicleRepository;

class VintageCollectorVehicle extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    {
        $this->calculateFees(new VintageCollectorVehicleRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param VintageCollectorVehicleRepository $repository
     */
    private function calculateFees(VintageCollectorVehicleRepository $repository)
    {
        $this->fees = [
            ...
            'PLATE_FEE' => 0, // Not yet implemeted.
        ];
