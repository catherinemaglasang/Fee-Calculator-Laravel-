...
class TrailerUtilityTrailer extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    {
        $this->calculateFees(new TrailerUtilityTrailerRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param TrailerUtilityTrailerRepository $repository
     */
    private function calculateFees(TrailerUtilityTrailerRepository $repository)
    {
        $this->fees = [
