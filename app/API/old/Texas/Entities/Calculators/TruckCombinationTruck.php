...
class TruckCombinationTruck extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    {
        $this->calculateFees(new TruckCombinationTruckRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param TruckCombinationTruckRepository $repository
     */
    private function calculateFees(TruckCombinationTruckRepository $repository)
    {
        $this->fees = [
