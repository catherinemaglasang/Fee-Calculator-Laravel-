...
class BusPrivateBus extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    {
        $this->calculateFees(new BusPrivateBusRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param BusPrivateBusRepository $repository
     */
    private function calculateFees(BusPrivateBusRepository $repository)
    {
        $this->fees = [
