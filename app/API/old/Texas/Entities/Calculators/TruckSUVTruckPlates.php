...
use Thirty98\API\Texas\Entities\Repositories\TruckSUVTruckPlatesRepository;
use Thirty98\API\Texas\Entities\Repositories\VanTruckPlatesTruckFeeRepository;

class TruckSUVTruckPlates extends Calculator
{
    const STATE_CODE = 'TX';
    ...
    {
        $this->calculateFees(new TruckSUVTruckPlatesRepository($this->calculatorInput->getRequest()));
     ...
     * Calculate all fees.
     *
     * @param TruckSUVTruckPlatesRepository $repository
     */
    private function calculateFees(TruckSUVTruckPlatesRepository $repository)
    {
        $this->fees = [
