...
class TrailerUtilityTrailer extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', TrailerUtilityTrailerRepository::CATEGORY)->first();
        $type = DB::table('types')->where('name', TrailerUtilityTrailerRepository::TYPE)->first();
