...
use Thirty98\API\Texas\Entities\Repositories\TruckTruckTractorRepository;

class TruckTruckTractor extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', TruckTruckTractorRepository::CATEGORY)->first();
        $type = DB::table('types')->where('name', TruckTruckTractorRepository::TYPE)->first();
