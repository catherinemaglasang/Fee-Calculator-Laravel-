...
class BusCityBus extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', BusCityBusRepository::CATEGORY)->first();
        $type = DB::table('types')->where('name', BusCityBusRepository::TYPE)->first();
