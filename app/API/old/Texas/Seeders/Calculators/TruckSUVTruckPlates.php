...
class TruckSUVTruckPlates extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', Slugifier::slugify('TRUCK'))->first();
        $type = DB::table('types')->where('name', Slugifier::slugify('SUV-Truck Plates'))->first();
