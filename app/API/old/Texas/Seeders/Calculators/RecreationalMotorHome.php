...
class RecreationalMotorHome extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', RecreationalMotorHomeRepository::CATEGORY)->first();
        $type = DB::table('types')->where('name', RecreationalMotorHomeRepository::TYPE)->first();
