...
class TruckPickupTruck1Ton extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', TruckPickupTruck1TonRepository::CATEGORY)->first();
        $type = DB::table('types')->where('name', TruckPickupTruck1TonRepository::TYPE)->first();
