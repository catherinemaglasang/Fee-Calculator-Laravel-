...
use Thirty98\API\Texas\Entities\Repositories\TrailerTrailerRepository;
use Thirty98\API\Texas\Entities\Repositories\TrailerTokenTrailerRepository;

class TrailerTrailer extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', TrailerTrailerRepository::CATEGORY)->first();
        $type = DB::table('types')->where('name', TrailerTrailerRepository::TYPE)->first();
