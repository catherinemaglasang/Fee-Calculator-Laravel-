...
class BusPrivateBus extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', BusPrivateBusRepository::CATEGORY)->first();
        $type = DB::table('types')->where('name', BusPrivateBusRepository::TYPE)->first();
