...
class PassengerPassenger extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', Slugifier::slugify('Passenger'))->first();
        $type = DB::table('types')->where('name', Slugifier::slugify('Passenger'))->first();
