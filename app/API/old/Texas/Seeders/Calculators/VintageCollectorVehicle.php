...
use Thirty98\API\Texas\Entities\Repositories\TrailerUtilityTrailerRepository;
use Thirty98\API\Texas\Entities\Repositories\VintageCollectorVehicleRepository;

class VintageCollectorVehicle extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', VintageCollectorVehicleRepository::CATEGORY)->first();
        $type = DB::table('types')->where('name', VintageCollectorVehicleRepository::TYPE)->first();
