...
class Truck12PickupTruck extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', Truck12PickupTruckRepository::CATEGORY)->first();
        $type = DB::table('types')->where('name', Truck12PickupTruckRepository::TYPE)->first();
