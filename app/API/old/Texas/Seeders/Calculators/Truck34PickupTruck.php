...
class Truck34PickupTruck extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', Truck34PickupTruckRepository::CATEGORY)->first();
        $type = DB::table('types')->where('name', Truck34PickupTruckRepository::TYPE)->first();
