...
class RecreationalTravelTrailer extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', RecreationalTravelTrailerRepository::CATEGORY)->first();
        $type = DB::table('types')->where('name', RecreationalTravelTrailerRepository::TYPE)->first();
