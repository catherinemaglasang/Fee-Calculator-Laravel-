...
class MotorcycleMotorcycle extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', MotorcycleMotorcycleRepository::CATEGORY)->first();
        $type = DB::table('types')->where('name', MotorcycleMotorcycleRepository::TYPE)->first();
