...
use Thirty98\API\Texas\Entities\Repositories\BusMotorBusRepository;

class BusMotorBus extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', BusMotorBusRepository::CATEGORY)->first();
        $type = DB::table('types')->where('name', BusMotorBusRepository::TYPE)->first();
