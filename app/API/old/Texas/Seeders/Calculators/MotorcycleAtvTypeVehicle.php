...
use Thirty98\API\Texas\Entities\Repositories\MotorcycleAtvTypeVehicleRepository;
use Thirty98\API\Texas\Entities\Repositories\MotorcycleMotorcycleRepository;
use Thirty98\API\Texas\Entities\Repositories\MotorcycleOffRoadMotorcycleRepository;

class MotorcycleAtvTypeVehicle extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', MotorcycleAtvTypeVehicleRepository::CATEGORY)->first();
        $type = DB::table('types')->where('name', MotorcycleAtvTypeVehicleRepository::TYPE)->first();
