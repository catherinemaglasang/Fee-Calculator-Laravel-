...
class MotorcycleMoped extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', MotorcycleMopedRepository::CATEGORY)->first();
        $type = DB::table('types')->where('name', MotorcycleMopedRepository::TYPE)->first();
