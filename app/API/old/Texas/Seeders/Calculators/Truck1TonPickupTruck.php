...
class Truck1TonPickupTruck extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', Truck1TonPickupTruckRepository::CATEGORY)->first();
        $type = DB::table('types')->where('name', Truck1TonPickupTruckRepository::TYPE)->first();
