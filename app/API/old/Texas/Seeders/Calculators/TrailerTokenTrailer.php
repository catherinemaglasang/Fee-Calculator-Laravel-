...
class TrailerTokenTrailer extends APISeeder
{
    public $fees;
    ...
    public function __construct()
    {
        ...
        // Get category type.
        $category = DB::table('categories')->where('name', TrailerTokenTrailerRepository::CATEGORY)->first();
        $type = DB::table('types')->where('name', TrailerTokenTrailerRepository::TYPE)->first();
