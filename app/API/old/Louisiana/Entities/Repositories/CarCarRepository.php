...
class CarCarRepository implements CalculatorRepositoryInterface
{
    private $ttltypes = [];
    ...
    public function getNotaryFee()
    {
        ...
        // DT, RO
        if (is_null($transaction_type) || ($transaction_type == 'TRC')) {
            return "";
        }
    ...
    public function getLicenseFeeByValue($taxable_value, $type, $category, $date_of_sale)
    {
        ...
        // License Fee = normalRound((Taxable Value - 10,000) * .001)
