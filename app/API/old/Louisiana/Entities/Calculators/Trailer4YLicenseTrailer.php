...
use Thirty98\API\Louisiana\Entities\Repositories\Trailer4YLicenseTrailerRepository;

class Trailer4YLicenseTrailer extends Calculator
{
    const STATE_CODE = 'LA';
    ...
    {
        $this->calculateFees(new Trailer4YLicenseTrailerRepository($this->calculatorInput->getRequest()));
     ...
     */
    private function calculateFees(Trailer4YLicenseTrailerRepository $repositories)
    {
        $this->fees = [
