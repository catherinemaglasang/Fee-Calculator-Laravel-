...
use Thirty98\API\Louisiana\Entities\Repositories\OffRoadOffRoadRepository;

class OffRoadOffRoad extends Calculator
{
    const STATE_CODE = 'LA';
    ...
    {
        $this->calculateFees(new OffRoadOffRoadRepository($this->calculatorInput->getRequest()));
     ...
     */
    private function calculateFees(OffRoadOffRoadRepository $repositories)
    {
        $this->fees = [
