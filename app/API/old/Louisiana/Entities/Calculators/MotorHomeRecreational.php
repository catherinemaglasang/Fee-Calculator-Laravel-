...
use Thirty98\API\Louisiana\Entities\Repositories\MotorHomeRecreationalRepository;

class MotorHomeRecreational extends Calculator
{
    const STATE_CODE = 'LA';
    ...
    {
        $this->calculateFees(new MotorHomeRecreationalRepository($this->calculatorInput->getRequest()));
     ...
     */
    private function calculateFees(MotorHomeRecreationalRepository $repositories)
    {
        $this->fees = [
