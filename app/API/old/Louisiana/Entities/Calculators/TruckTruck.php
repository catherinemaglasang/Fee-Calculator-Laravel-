...
use Thirty98\API\Louisiana\Entities\Repositories\TruckTruckRepository;

class TruckTruck extends Calculator
{
    const STATE_CODE = 'LA';
    ...
    {
        $this->calculateFees(new TruckTruckRepository($this->calculatorInput->getRequest()));
     ...
     */
    private function calculateFees(TruckTruckRepository $repositories)
    {
        $this->fees = [
