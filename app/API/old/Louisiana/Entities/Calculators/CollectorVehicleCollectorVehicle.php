...
use Thirty98\API\Louisiana\Entities\Repositories\CollectorVehicleCollectorVehicleRepository;

class CollectorVehicleCollectorVehicle extends Calculator
{
    const STATE_CODE = 'LA';
    ...
    {
        $this->calculateFees(new CollectorVehicleCollectorVehicleRepository($this->calculatorInput->getRequest()));
     ...
     */
    private function calculateFees(CollectorVehicleCollectorVehicleRepository $repositories)
    {
        $this->fees = [
