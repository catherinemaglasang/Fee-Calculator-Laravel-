...
use Thirty98\API\Louisiana\Entities\Repositories\SUVSUVRepository;

class SUVSUV extends Calculator
{
    const STATE_CODE = 'LA';
    ...
    {
        $this->calculateFees(new SUVSUVRepository($this->calculatorInput->getRequest()));
     ...
     */
    private function calculateFees(SUVSUVRepository $repositories)
    {
        $this->fees = [
