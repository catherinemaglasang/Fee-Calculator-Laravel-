...
use Thirty98\API\Louisiana\Entities\Repositories\MotorcycleMotorcycleRepository;

class MotorcycleMotorcycle extends Calculator
{
    const STATE_CODE = 'LA';
    ...
    {
        $this->calculateFees(new MotorcycleMotorcycleRepository($this->calculatorInput->getRequest()));
     ...
     */
    private function calculateFees(MotorcycleMotorcycleRepository $repositories)
    {
        $this->fees = [
