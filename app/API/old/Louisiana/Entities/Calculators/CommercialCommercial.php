...
use Thirty98\API\Louisiana\Entities\Repositories\CommercialCommercialRepository;

class CommercialCommercial extends Calculator
{
    const STATE_CODE = 'LA';
    ...
    {
        $this->calculateFees(new CommercialCommercialRepository($this->calculatorInput->getRequest()));
     ...
     */
    private function calculateFees(CommercialCommercialRepository $repositories)
    {
        $this->fees = [
