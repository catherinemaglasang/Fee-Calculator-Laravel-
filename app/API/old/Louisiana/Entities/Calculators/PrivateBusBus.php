...
use Thirty98\API\Louisiana\Entities\Repositories\PrivateBusBusRepository;

class PrivateBusBus extends Calculator
{
    const STATE_CODE = 'LA';
    ...
    {
        $this->calculateFees(new PrivateBusBusRepository($this->calculatorInput->getRequest()));
     ...
     */
    private function calculateFees(PrivateBusBusRepository $repositories)
    {
        $this->fees = [
