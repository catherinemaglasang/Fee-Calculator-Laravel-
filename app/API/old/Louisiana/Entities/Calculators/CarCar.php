...
use Thirty98\API\Louisiana\Entities\Repositories\CarCarRepository;
...
class CarCar extends Calculator
{
    ...
    {
        $this->calculateFees(new CarCarRepository($this->calculatorInput->getRequest()));
     ...
     */
    private function calculateFees(CarCarRepository $repositories)
    {
        $this->fees = [
