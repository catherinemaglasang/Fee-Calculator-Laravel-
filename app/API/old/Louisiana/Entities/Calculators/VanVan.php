...
use Thirty98\API\Louisiana\Entities\Repositories\VanVanRepository;

class VanVan extends Calculator
{
    const STATE_CODE = 'LA';
    ...
    {
        $this->calculateFees(new VanVanRepository($this->calculatorInput->getRequest()));
     ...
     */
    private function calculateFees(VanVanRepository $repositories)
    {
        $this->fees = [
