...
use Thirty98\API\Louisiana\Entities\Repositories\TruckTractorTruckTractorRepository;

class TruckTractorTruckTractor extends Calculator
{
    const STATE_CODE = 'LA';
    ...
    {
        $this->calculateFees(new TruckTractorTruckTractorRepository($this->calculatorInput->getRequest()));
     ...
     */
    private function calculateFees(TruckTractorTruckTractorRepository $repositories)
    {
        $this->fees = [
