...
use Thirty98\API\Louisiana\Entities\Repositories\TrailerUtilityTrailerRepository;
...
class TrailerUtilityTrailer extends Calculator
{
     ...
     */
    private function calculateFees(TrailerUtilityTrailerRepository $repositories)
    {
        $this->fees = [
