...
use Thirty98\API\Louisiana\Entities\Repositories\Trailer1YLicenseTrailerRepository;

class Trailer1YLicenseTrailer extends Calculator
{
    const STATE_CODE = 'LA';
    ...
    {
        $this->calculateFees(new Trailer1YLicenseTrailerRepository($this->calculatorInput->getRequest()));
     ...
     */
    private function calculateFees(Trailer1YLicenseTrailerRepository $repositories)
    {
        $this->fees = [
