...
use Thirty98\API\Louisiana\Entities\Repositories\SemiTrailerTrailerRepository;

class SemiTrailerTrailer extends Calculator
{
    const STATE_CODE = 'LA';
    ...
    {
        $this->calculateFees(new SemiTrailerTrailerRepository($this->calculatorInput->getRequest()));
     ...
     */
    private function calculateFees(SemiTrailerTrailerRepository $repositories)
    {
        $this->fees = [
