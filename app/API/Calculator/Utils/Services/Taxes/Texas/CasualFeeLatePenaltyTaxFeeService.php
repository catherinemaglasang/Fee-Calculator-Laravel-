...
class CasualFeeLatePenaltyTaxFeeService extends AbstractTaxFeeService
{
    protected $state = 'TX';
    ...
    {
        return $this->vehicle_service->getVehicleFeeByState($this->state, $this->vehicle_type, 'casual_late_penalty');
    }
}
