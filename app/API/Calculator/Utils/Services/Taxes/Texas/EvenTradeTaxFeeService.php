...
class EvenTradeTaxFeeService extends AbstractTaxFeeService
{
    protected $state = 'TX';
    ...
    {
        return $this->vehicle_service->getVehicleFeeByState($this->state, $this->vehicle_type, 'even_trade_tax');
    }
}
