...
class YoungFarmerTaxFeeService extends AbstractTaxFeeService
{
    protected $state = 'TX';
    ...
    {
        return $this->vehicle_service->getVehicleFeeByState($this->state, $this->vehicle_type, 'young_farmer_fee');
    }
}
