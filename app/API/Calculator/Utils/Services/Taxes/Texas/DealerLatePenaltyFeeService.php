...
class DealerLatePenaltyFeeService extends AbstractTaxFeeService
{
    protected $state = 'TX';
    ...
    {
        return $this->vehicle_service->getVehicleFeeByState($this->state, $this->vehicle_type, 'dealer_late_penalty');
    }
}
