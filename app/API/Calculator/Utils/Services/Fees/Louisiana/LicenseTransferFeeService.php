...
class LicenseTransferFeeService  extends AbstractTitleFeeService
{
    ...
    {
        return $this->vehicle_service->getVehicleFeeByState($this->state, $this->vehicle_type, 'license_transfer_fee');
    }
}
