...
class AntiqueVehicle extends LouisianaCalculator
{
    /**
    ...
    {
        return (float) $this->service->getVehicleFeeByState($this->params['state']['code'], $this->params['vehicle_type']['slug'], 'antique_plate');
    }
}
