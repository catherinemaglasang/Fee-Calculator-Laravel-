		...
		<div class="calculator-wrapper clearfix @if(!$data['agent']) desktop-calculator-wrapper @endif" equalizeheight>
					...
					<div class="summary options">
						...
						<div class="summary-content">
							...
							<div ng-if="fields.temp_tag.show" class="summary-row clearfix">
								<input id="temp_tag" type="checkbox" name="temp_tag" ng-model="params.temp_tag">
								<label for="temp_tag">Temp Tag</label>
							</div>
							<div ng-if="fields.is_trade_in_leased.show" class="summary-row clearfix" ng-click="taxableUpdate()">
								<input id="is_trade_in_leased" type="checkbox" name="is_trade_in_leased" ng-model="params.is_trade_in_leased">
							...
							<div ng-if="fields.farm_ranch.show && showFarmranch" class="summary-row clearfix">
								<input id="farm_ranch" type="checkbox" name="farm_ranch" ng-model="params.farm_ranch">
								<label for="farm_ranch">Farm/Ranch</label>
							</div>
							<div ng-if="fields.member_of_military.show" class="summary-row clearfix">
								<input id="member_of_military" type="checkbox" name="member_of_military" ng-model="params.member_of_military">
								<label for="member_of_military">Member of Military</label>
							</div>
							<div ng-if="fields.off_highway_use.show && showAddress" class="summary-row clearfix">
								<input id="off_highway_use" type="checkbox" name="off_highway_use" ng-model="params.off_highway_use">
								<label for="off_highway_use">Off Highway Use</label>
							</div>
							<div ng-if="fields.rebuilt_salvage.show" class="summary-row clearfix">
								<input id="rebuilt_salvage" type="checkbox" name="rebuilt_salvage" ng-model="params.rebuilt_salvage">
							...
							<div ng-if="fields.include_inspection_fee.show" class="summary-row clearfix">
								<input id="include_inspection_fee" type="checkbox" name="include_inspection_fee" ng-model="params.include_inspection_fee">
							...
							<div ng-if="fields.include_vit_tax.show" class="summary-row clearfix">
								<input id="include_vit_tax" type="checkbox" name="include_vit_tax" ng-model="params.include_vit_tax">
			...
			<div class="module-wrapper @if(!$data['agent']) desktop-module-wrapper @endif" equalizeheightadd>
				...
				<h1><i class="fa fa-calculator"></i>&nbsp;Sales Tax Calculator</h1>
					<form id="calculator" class="clearfix" calculator>
						<div class="form-group clearfix">
							<label for="category">Transaction Type<span class="req-mark">*</span></label>
							<div class="has-select">
								<select ng-model="ttlType" name="transaction_type" ng-options="transaction.name for transaction in transactionTypes track by transaction.code" ng-change="changeTrasaction()"></select>
							</div>
						</div>
						...
						<div ng-model="params.resident_county" validateaddress>
							<div ng-if="fields.street_address.show && showAddress" class="form-group clearfix" ng-model="fields.street_address.required" field>
								<label for="address">Dealer Address</label>
								<input type="text" ng-model="params.street_address">
							</div>
							<div ng-if="fields.zip.show && showAddress" class="form-group clearfix" ng-model="fields.zip.required" field>
								<label for="address">Zip</label>
								<input type="text" ng-model="params.zip" valid="TX" zip>
							</div>
						</div>
						<div ng-if="fields.resident_county.show && showAddress" class="form-group clearfix" ng-model="fields.resident_county.required" field>
							...
							<div class="has-select">
								<select ng-model="residentCounty" name="resident_county" title="Resident County" ng-options="county as county.title for county in counties track by county.slug" selectcheck></select>
							</div>
						</div>
						...
						<div id="weigths" ng-model="params.gvw" weights>
                            ...
                            <div ng-if="fields.trailer_weight.show && pullingTrailer" class="form-group clearfix" ng-model="fields.trailer_weight.required" field>
						...
						<div ng-if="fields.gvw.show" class="form-group clearfix" ng-model="fields.gvw.required" field>
							<label>GVW</label>
							<div class="is-weight">
								<input disabled="disabled" type="text" placeholder="0" ng-model="params.gvw">
							</div>
						</div>
						...
						<div ng-if="fields.inspection_type.show && includeInspectionFee" class="form-group clearfix" ng-model="fields.inspection_type.required" field>
							...
							<div class="has-select">
								...
								<select ng-model="params.inspection_type" name="inspection_type" title="Inspection Type" ng-options="inspection as inspection.title for inspection in inspectionTypes track by inspection.code" selectcheck></select>
						...
						<div ng-if="fields.freight.show" class="form-group clearfix" ng-model="fields.freight.required" field>
                            ...
                            <div class="is-currency">
                                <input type="text" name="freight" placeholder="0.00" ng-model="params.freight" currency>
                            </div>
						</div>
						<!-- 
						...
						<div id="sales-tax" ng-model="taxable_value" salestax>
							...
							<div ng-if="fields.trade_in_value.show" class="form-group clearfix" ng-model="fields.trade_in_value.required" field>
								...
								<div class="is-currency">
									<input type="text" title="Trade-in Value" placeholder="0.00" ng-model="params.trade_in_value" name="trade_in_value" operation="-">
								</div>
							</div>
						...
						<div ng-if="fields.taxable_value.show" class="form-group clearfix" ng-model="fields.taxable_value.required" field>
							...
							<div class="is-currency">
								<input disabled="disabled" type="text" placeholder="0.00" ng-model="taxable_value">
							</div>
						</div>
						<!-- End sales tax -->
						...
						<button type="reset" class="rese">Reset</button>
