<div class="alert alert-info">
	<div class="mobile-selects selects has-button clearfix">
		...
		<button v-on="click: changeCounty()" v-attr="disabled:! enableChange">Edit</button>
	</div>
	...
	<div class="mobile-selects selects">
		...
		<div class="has-select">
			<select name="type" v-model="updates.type" v-on="change: fetchData('fees')" v-attr="disabled:! enableType">
